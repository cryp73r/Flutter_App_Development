                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      child: Image.network(
                        getImageData(imageNameFixer(rawData["data"]["movies"][index]["slug"]), "medium-cover"),
                        fit: BoxFit.fill,
                  ...
                  Text(rawData["data"]["movies"][index]["title"].length<=15?rawData["data"]["movies"][index]["title"]:"${rawData["data"]["movies"][index]["title"].substring(0, 15)}...", style: TextStyle(
                    fontWeight: FontWeight.bold
                  ),),
                  Text("${rawData["data"]["movies"][index]["year"]}", style: TextStyle(fontWeight: FontWeight.w400, fontStyle: FontStyle.italic, color: Colors.white70),),
                ],
              ),),
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => MovieDetailScreen(movieId: rawData["data"]["movies"][index]["id"])));
              },
            );
          },
      ),
